...
public class DialogSaveResultData extends PJDialogBase {
	...
	public DialogSaveResultData() {
		this(Main.getMDIMain(), "Save Sql Result Data As", true);
	}
	...
	class ThreadDoInsert extends Thread {
		public void run() {
			...
			try {
				...
				Vector columnNameVector = tableModel.getRealColumnName();
				Vector typeVector = tableModel.getColumnJavaType();
				Vector sizeVector = tableModel.getSizeVector();
				Vector keyVector = tableModel.getKeyVector();
				...
				for (int i = 0; i < totalSize; i++) {
					Vector oneRow = tableModel.getRowData(i);
